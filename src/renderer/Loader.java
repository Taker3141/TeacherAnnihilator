...
public class Loader
{
	...
	public SimpleModel loadToVAO(float[] positions, float[] textureCoords, float[] normals, int[] indices)
	{
		int vaoID = createVAO();
	...
	public SimpleModel loadToVAO(float positions[])
	{
		int vaoID = createVAO();
		storeDataInAttributeList(0, 2, positions);
		unbindVAO();
		return new SimpleModel(vaoID, positions.length / 2);
	}
