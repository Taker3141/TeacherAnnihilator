...
public class Person extends Movable
{
	...
	public Person(String texture, Vector3f position, float rotX, float rotY, float rotZ, float scale, List<Entity> list, float mass)
	{
	...
	protected void addBodyParts()
	{
		...
		bodyParts.put("head", new BodyPart(new TexturedModel(head, tex), this, new Vector3f(0, 4.3F, 0), new Vector3f(0.2F, 0.2F, 0.2F), new Vector3f(-0.1F, 0, -0.1F), 10));
		...
		bodyParts.put("leftLeg", new BodyPart(new TexturedModel(leg, tex), this, new Vector3f(0.4F, 1.7F, 0), new Vector3f(0.05F, 0.15F, 0.05F), new Vector3f(-0.025F, -0.15F, -0.025F), 10).setAnimations(a));
		a = new HashMap<>(a);
		...
		bodyParts.put("rightArm", new BodyPart(new TexturedModel(arm, tex), this, new Vector3f(-1F, 3.7F, 0), new Vector3f(0.05F, 0.1F, 0.05F), new Vector3f(-0.025F, -0.1F, -0.025F), 10).setAnimations(a));
		a = new HashMap<>();
		a.put(IDLE, new Animation(new Vector3f[] {new Vector3f(0, 0, 0)}, new float[] {1}));
		a.put(WALKING, new Animation(new Vector3f[] {new Vector3f(30, 0, 0), new Vector3f(-60, 0, 0), new Vector3f(30, 0, 0)}, new float[] {0.2F, 0.4F, 0.2F}));
		a.put(RUNNING, new Animation(new Vector3f[] {new Vector3f(40, 0, 0), new Vector3f(-80, 0, 0), new Vector3f(40, 0, 0)}, new float[] {0.1F, 0.2F, 0.1F}));
		bodyParts.put("leftArm", new BodyPart(new TexturedModel(arm, tex), this, new Vector3f(1F, 3.7F, 0), new Vector3f(0.05F, 0.1F, 0.05F), new Vector3f(-0.025F, -0.1F, -0.025F), 5).setAnimations(a));
		a = new HashMap<>(a);
		...
		bodyParts.put("rightLeg", new BodyPart(new TexturedModel(leg, tex), this, new Vector3f(-0.4F, 1.7F, 0), new Vector3f(0.05F, 0.15F, 0.05F), new Vector3f(-0.025F, -0.15F, -0.025F), 5).setAnimations(a));
